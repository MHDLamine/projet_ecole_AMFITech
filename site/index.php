...
<html lang="fr">
  ...
  <ul class="dropdown-menu">
    ...
    <li><a class="dropdown-item" href="./compte/admin.php">Administrateur</a></li>
...
​​​​​​​Ainsi, se former aux métiers du numérique ouvre de belles perspectives d’avenir, quels que soient les secteurs d’activité.</p></div>
                    ...
                    <div class="col-lg-8 col-xl-7">
                        ...
                        <form id="contactForm" data-sb-form-api-token="API_TOKEN">
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <div class="invalid-feedback" data-sb-feedback="email:required">Champ obligatoire.</div>
                                <div class="invalid-feedback" data-sb-feedback="email:email">Respectez le format.</div>
                            </div>
                            <!-- Phone number input-->
                            <div class="form-floating mb-3">
                                <input class="form-control" id="phone" type="number" placeholder="(+221) 7X XXX XX XX" data-sb-validations="required" />
                                <label for="phone">Numéro Téléphone</label>
                                <div class="invalid-feedback" data-sb-feedback="phone:required">Numéro de Téléphone obligatoire.</div>
                            </div>
                            <!-- Message input-->
                            <div class="form-floating mb-3">
                            ...
                            <div class="d-none" id="submitSuccessMessage">
                                <div class="text-center mb-3">
                                    <div class="fw-bolder">Message envoyé avec succès à l'école de la Réussite</div>
        ...
        <div class="copyright py-4 text-center text-white">
            <div class="container"><small>Copyright &copy; AMFI TECH 2022</small></div>
        </div>
        <!-- Portfolio Modals-->
        <!-- Portfolio Modal 1-->
